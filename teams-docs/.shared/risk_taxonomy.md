...
| **R-attend** ⭐ | 출결 이슈 — 회의 결석 / 조퇴 / 1시간 미만 참여 | 결석/조퇴 1회 + 당일 활동 < 평소의 30% | (1) 사유 확인 / (2) 1일 단발: 회의록 기록 / (3) 2일 연속: 강사 1:1 통지 + 분담 재조정 / (4) 3일+: 강사 보고 |
| **R-burn** ⭐ | 피로 누적 / 번아웃 leading indicator | 다음 중 2개 이상 발현: 일일 활동 ≥ 다른 멤버 평균 × 1.3 / open assign ≥ 4 / 본인 또는 강사 명시 우려 발언 | (1) 작업 분산 권장 / (2) 강사 페이스 조절 명시 권유 / (3) PM 신호등 회고로 매일 점검 |

→ **R-attend·R-burn 표준화 근거**: 2026-05-14 1팀 정섭 결석 + 손지희 "아 너무 힘들어요" 사례. 팀별 변형(R-burn-1, R-burn-team2 등)은 본 표준의 임계값 조정만 부록에 명시.
